    ...
    <div class="page">
        <div class="search_block">
            <form>
                ...
                <a class="submit">
                    <span>
                        <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 56.966 56.966" xml:space="preserve"><path d="M55.146,51.887L41.588,37.786c3.486-4.144,5.396-9.358,5.396-14.786c0-12.682-10.318-23-23-23s-23,10.318-23,23s10.318,23,23,23c4.761,0,9.298-1.436,13.177-4.162l13.661,14.208c0.571,0.593,1.339,0.92,2.162,0.92c0.779,0,1.518-0.297,2.079-0.837C56.255,54.982,56.293,53.08,55.146,51.887z M23.984,6c9.374,0,17,7.626,17,17s-7.626,17-17,17s-17-7.626-17-17S14.61,6,23.984,6z" fill="#000000"></path></svg>
                    </span>
                </a>
                <span class="categories">
                    <svg viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg"><g id="Line"><rect height="12" rx="5" width="44" x="2" y="18" fill="#000000"></rect><rect height="12" rx="5" width="44" x="2" y="34" fill="#000000"></rect><rect height="12" rx="5" width="44" x="2" y="2" fill="#000000"></rect></g></svg>
                </span>
            </form>
        </div>
    </div>
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                <div class="product-card">
                    ...
                    <form method="POST" action="">
                        ...
                        <input type="hidden" name="user_id" value="<?php echo $_SESSION['user']['id']; ?>"> <!-- ID пользователя -->
